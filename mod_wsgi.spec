...
Source0  : https://github.com/GrahamDumpleton/mod_wsgi/archive/5.0.1/mod_wsgi-5.0.1.tar.gz
...
%prep
%setup -q -n mod_wsgi-5.0.1
cd %{_builddir}/mod_wsgi-5.0.1
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a mod_wsgi-5.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727974356
