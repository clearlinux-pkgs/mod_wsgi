...
Version  : 5.0.0
Release  : 71
URL      : https://github.com/GrahamDumpleton/mod_wsgi/archive/5.0.0/mod_wsgi-5.0.0.tar.gz
Source0  : https://github.com/GrahamDumpleton/mod_wsgi/archive/5.0.0/mod_wsgi-5.0.0.tar.gz
...
%prep
%setup -q -n mod_wsgi-5.0.0
cd %{_builddir}/mod_wsgi-5.0.0
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a mod_wsgi-5.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719977667
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib/httpd/modules/mod_wsgi.so
